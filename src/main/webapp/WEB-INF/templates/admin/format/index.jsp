				...
				<tr>
					...
					<td>
						<a class="btn btn-small btn-success"
						   href="${pageContext.request.contextPath}/admin/format/edit?id=${v.id}">Sửa</a>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a type="button"
								   href="${pageContext.request.contextPath}/admin/format/delete?id=${v.id}"
				...
				<c:forEach begin="1" end="${Math.ceil(totalItems/page)}" var="i">
					<li class="page-item active">
						<a class="page-link" id="${i}"
						   href="${pageContext.request.contextPath}/admin/format?<c:if test="${name != ''}">name=${name}&</c:if>page=${i}">${i}</a>
					</li>
				</c:forEach>
			</ul>
		</nav>
