                ...
                <tr>
                    ...
                    <td>
                        <a class="btn btn-small btn-success"
                           href="${pageContext.request.contextPath}/admin/type/edit?id=${type.id}">Sửa</a>
                        <a class="btn btn-small btn-danger" data-toggle="modal" href='#modal-id-${type.id}'>Xóa</a>
                    </td>
                </tr>
                <div class="modal fade" id="modal-id-${type.id}">
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;
                                </button>
                                <h4 class="modal-title">Bạn có chắc xóa: ${type.name}</h4>
                            </div>
                                <%--									<div class="modal-body">--%>
                                <%--										<h5>Bạn có chắc muốn xóa: ${type.name}</h5>--%>
                                <%--									</div>--%>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
                                <a type="button"
                                   href="${pageContext.request.contextPath}/admin/type/delete?id=${type.id}"
