        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <form:form action="insert" modelAttribute="country" method="post">
                <form:input path="id" type="hidden" value="${country.id}"/>
						<div class="form-group">
							<label for="">Quốc gia</label>
							<form:input path="name" cssClass="form-control" value="${country.name}"/>
							<form:errors path="name" cssClass="erorr" />
						</div>
						<div class="form-group">
							<label for="">Tên viết tắt</label>
							<form:input path="short_name" cssClass="form-control" value="${country.short_name}"/>
