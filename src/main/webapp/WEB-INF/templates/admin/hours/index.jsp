...
<div class="box">
	<div class="box-header with-border">
		...
		<form action="" method="get" class="form-inline"
			...
			<a href="${pageContext.request.contextPath}/admin/hours/insert"
				...
				<tr>
					...
					<td>
						<a class="btn btn-small btn-success"
						   href="${pageContext.request.contextPath}/admin/hours/edit?id=${v.id}">Sửa</a>
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-footer">
								...
								<a type="button"
								   href="${pageContext.request.contextPath}/admin/hours/delete?id=${v.id}"
