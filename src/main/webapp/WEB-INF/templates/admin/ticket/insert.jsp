...
<div class="box">
  <div class="box-header with-border">
    ...
    <form action="" method="get" class="form-inline"
      ...
      <a href="${pageContext.request.contextPath}/admin/ticket/insert"
        ...
        <tr>
          ...
          <td>
            ...
            <a class="btn btn-small btn-success"
               href="${pageContext.request.contextPath}/admin/ticket/edit?id=${v.id}">Sửa</a>
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              ...
              <div class="modal-footer">
                ...
                <a type="button"
                   href="${pageContext.request.contextPath}/admin/ticket/delete?id=${v.id}"
          ...
          <div class="modal-dialog">
            <div class="modal-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title">Chi tiết rạp: ${v.short_name}</h4>
              </div>
              <div class="modal-body">
                <p>Số điện thoại: ${v.phone_number}</p>
                <p>Địa chỉ: ${v.address}</p>
                <h4>Danh sách phòng</h4>
                <c:forEach items="${v.room}" var="r">
                  <p>Tên phòng ${r.name} - Tổng số ghế ${r.total}</p>
                </c:forEach>
              </div>
              <div class="modal-footer">
                <button type="button" class="btn btn-default" data-dismiss="modal">Đóng</button>
        ...
        <c:forEach begin="1" end="${Math.ceil(totalItems/page)}" var="i">
          <li class="page-item active">
            <a class="page-link" id="${i}"
               href="${pageContext.request.contextPath}/admin/ticket?<c:if test="${name != ''}">name=${name}&</c:if>page=${i}">${i}</a>
          </li>
        </c:forEach>
      </ul>
    </nav>
