        ...
        <div class="box-body">
          <div class="row">
            <div class="col-md-12">
                ...
                <form:form action="insert" modelAttribute="format" method="post">
                <form:input path="id" type="hidden" value="${format.id}"/>
						<div class="form-group">
							<label for="">Định dạng phim</label>
							<form:input path="name" cssClass="form-control" value="${format.name}"/>
