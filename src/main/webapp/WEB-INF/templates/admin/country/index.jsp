				...
				<tbody>
					<c:forEach items="${countrys}" var="country">
						<tr>
							...
							<td>
							<a class="btn btn-small btn-success" href="${pageContext.request.contextPath}/admin/country/edit?id=${country.id}">Sửa</a>
							<a class="btn btn-small btn-danger" href="${pageContext.request.contextPath}/admin/country/delete?id=${country.id}" onclick="return confirm('Bạn có muốn xóa không ?')">Xóa</a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
